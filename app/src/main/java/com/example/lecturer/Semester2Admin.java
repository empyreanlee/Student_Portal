...
public class Semester2Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iconButton1.setOnClickListener(v -> {
            Intent intent = new Intent(Semester2Admin.this, Semester1.class);
        ...
        iconButton2.setOnClickListener(v -> {
            Intent intent = new Intent(Semester2Admin.this, Semester2Admin.class);
            startActivity(intent);
                                            ...
                                            if (marksSnapshot != null && marksSnapshot.exists()) {
                                                ...
                                                marksDocRef.update("assignment1", assignment1,
                                                        ...
                                                        .addOnSuccessListener(aVoid -> {
                                                            ...
                                                            Toast.makeText(Semester2Admin.this, "Marks updated successfully", Toast.LENGTH_SHORT).show();
                                                        })
                                                        .addOnFailureListener(e -> {
                                                            Log.d("Firestore", "Failed to update marks");
                                                            // Handle the error
                                                            Toast.makeText(Semester2Admin.this, "Error updating marks: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                        });
                                            } else {
                                                ...
                                                marksDocRef.set(marks)
                                                        .addOnSuccessListener(aVoid -> {
                                                            ...
                                                            Toast.makeText(Semester2Admin.this, "Marks added successfully", Toast.LENGTH_SHORT).show();
                                                        })
                                                        .addOnFailureListener(e -> {
                                                            Log.d("Firestore", "Failed to add marks");
                                                            // Handle the error
                                                            Toast.makeText(Semester2Admin.this, "Error adding marks: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                        });
                                            }
                                        } else {
                                            // Handle the error
                                            Toast.makeText(Semester2Admin.this, "Error fetching marks details: " + marksTask.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                } else {
                                    Toast.makeText(Semester2Admin.this, "Invalid courseName", Toast.LENGTH_SHORT).show();
                                }
                            }
                        } else {
                            Toast.makeText(Semester2Admin.this, "Error fetching semester details: " + semesterTask.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                } else {
                    Toast.makeText(Semester2Admin.this, "Student not found", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(Semester2Admin.this, "Error fetching student details: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
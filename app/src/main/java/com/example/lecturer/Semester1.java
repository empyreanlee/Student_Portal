...
public class Semester1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iconButton1.setOnClickListener(v -> {
            Intent intent = new Intent(Semester1.this, Semester1.class);
            startActivity(intent);
        });
        iconButton2 = findViewById(R.id.iconButton2);
        iconButton2.setOnClickListener(v -> {
            Intent intent = new Intent(Semester1.this, Semester2.class);
            startActivity(intent);
        });
                                    ...
                                    marksDocRef.get().addOnCompleteListener(marksTask -> {
                                        if (marksTask.isSuccessful()) {
                                            ...
                                            if (marksSnapshot != null && marksSnapshot.exists()) {
                                                ...
                                                Toast.makeText(Semester1.this, "Marks for this course already exist. Editing not allowed.", Toast.LENGTH_SHORT).show();
                                            } else {
                                                ...
                                                marksDocRef.set(marks)
                                                        .addOnSuccessListener(aVoid -> {
                                                            ...
                                                            Toast.makeText(Semester1.this, "Marks added successfully", Toast.LENGTH_SHORT).show();
                                                        })
                                                        .addOnFailureListener(e -> {
                                                            Log.d("Firestore", "Failed: ");// Handle the error
                                                            Toast.makeText(Semester1.this, "Error adding marks: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                        });
                                            }
                                        } else {
                                            // Handle the error
                                            Toast.makeText(Semester1.this, "Error fetching marks details: " + marksTask.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                } else {
                                    Toast.makeText(Semester1.this, "Invalid courseName", Toast.LENGTH_SHORT).show();
                                }
                            }
                        } else {
                            Toast.makeText(Semester1.this, "Error fetching semester details: " + semesterTask.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                } else {
                    Toast.makeText(Semester1.this, "Student not found", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(Semester1.this, "Error fetching student details: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
